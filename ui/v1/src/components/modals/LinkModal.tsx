...
const LinkModal = () => {
  ...
  return (
    <Modal show={isOpen} onClose={() => setOpen(false)} width="medium" overflow="visible">
        ...
        <div className="mt-3 text-center sm:mt-0 sm:text-left w-full ">
          <div className=" w-full flex flex-col gap-4 ">
            ...
            <a
              ...
              target="_blank"
              href={props.url}>
              <img className="favicon pr-1" src="https://icons.duckduckgo.com/ip3/www.youtube.com.ico" alt="favicon" />{' '}
              <span className="break-all">{props.url}</span>{' '}
              <svg
            ...
            <select id="location" name="location" className="input mt-1 w-full" defaultValue="Canada">
